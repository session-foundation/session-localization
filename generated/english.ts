...
export const enSimpleNoArgs = {
  ...
  proAccessRenewStart: 'Renew your Pro access to start using powerful Session Pro Beta features and support the project again.',
  ...
  proFullestPotential: 'Want to use Session to its fullest potential?<br/>Upgrade to Session Pro Beta to get access to exclusive features and help support the project.',
  ...
  proRefundRequestSessionSupport: 'Your refund request will be handled by Session Support.<br/><br/>Request a refund by hitting the button below and submitting a Session Pro support ticket.<br/><br/>While Session Support strives to process refund requests within 24-72 hours, processing may take longer during times of high request volume.',
  ...
  proThanksForSupporting: 'Thank you for supporting Session!',
  ...
  pro_error_expired: 'Your Pro subscription has expired.',
  pro_error_not_subscribed: 'You do not have an active Pro subscription.',
  pro_error_revoked: 'Your Pro subscription is no longer active',
  pro_error_stale_request: 'Your device\'s clock appears to be incorrect. Check your date and time settings and try again.',
  pro_error_unknown_payment: 'Your Pro payment could not be verified. Please wait a few minutes and try again.',
  pro_provider_app_store_account: 'Apple account',
  pro_provider_app_store_device: 'iOS',
  pro_provider_app_store_platform: 'Apple',
  pro_provider_app_store_store: 'Apple App Store',
  pro_provider_google_play_account: 'Google account',
...
export const enSimpleWithArgs = {
  ...
  proAccessRenewDesktop: 'Currently, Pro access can only be purchased and renewed via support platforms:{pro_stores}<br/>Because you are using Session Desktop, you\'re not able to renew here.<br/><br/>Session developers are working hard on alternative payment options to allow users to purchase Pro access outside of the above platforms. <b>Pro Roadmap</b> {icon}',
  ...
  proAccessUpgradeDesktop: 'Currently, Pro access can only be purchased via one of our supported platforms:{pro_stores}<br/>Because you are using Session Desktop, you\'re not able to upgrade to Pro here.<br/><br/>Session developers are working hard on alternative payment options to allow users to purchase Pro access outside of the platforms listed above. <b>Pro Roadmap</b> {icon}',
  ...
  proPlanPlatformRefundLong: 'Because you originally signed up for Session Pro via the <b><span>{platform_store}</span></b>, your refund request will be processed by Session Support.<br/><br/>Request a refund by hitting the button below and submitting a Session Pro support ticket.<br/><br/>While Session Support strives to process refund requests within 24-72 hours, processing may take longer during times of high request volume.',
  ...
  proRenewDesktopLinked: 'Renew your Pro access from the Session Pro settings on a linked device with Session installed via one of the support platforms:{pro_stores}',
  ...
  proRenewingNoAccessBilling: 'Currently, Pro access can only be purchased and renewed via one the supported platforms:{pro_stores}<br/>Because you installed Session using the {build_variant}, you\'re not able to renew here.<br/><br/>Session developers are working hard on alternative payment options to allow users to purchase Pro access outside of the platforms listed above.<b> Pro Roadmap</b> {icon}',
  ...
  proUpgradeDesktopLinked: 'Upgrade to Pro from the Session Pro settings on a linked device with Session installed via the our of our supported platforms:{pro_stores}',
  proUpgradeNoAccessBilling: 'Currently, Pro access can only be purchased via one of our supported platforms:{pro_stores}<br/>Because you installed Session using the {build_variant}, you\'re not able to upgrade to Pro here.<br/><br/>Session developers are working hard on alternative payment options to allow users to purchase Pro access outside of the platforms listed above.<b> Pro Roadmap</b> {icon}',
