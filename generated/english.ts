...
export const enSimpleWithArgs = {
  ...
  cancelProPlatform: 'Cancel on the {platform} website, using the {platform_account} you signed up for Pro with.',
  cancelProPlatformStore: 'Cancel on the {platform_store} website, using the {platform_account} you signed up for Pro with.',
  ...
  proRefundSupport: 'Please contact {platform} for further updates on your refund request. Due to {platform} refund policies, Session developers have no ability to influence the outcome of refund requests.<br/><br/><span>{platform} Refund Support</span>',
  ...
  proUpdateAccessDescription: 'Your current billing option grants <b>{current_plan_length}</b> of Pro access. Are you sure you want to switch to the <b>{selected_plan_length_singular}</b> billing option?<br/><br/>By updating, your Pro access will automatically renew on <b>{date}</b> for an additional <b>{selected_plan_length}</b> of Pro access.',
