...
export const enSimpleWithArgs = {
  ...
  cancelProPlatform: 'Cancel on the <span>{platform} website</span>, using the {platform_account} you signed up for Pro with.',
  cancelProPlatformStore: 'Cancel on the <span>{platform_store} website</span>, using the {platform_account} you signed up for Pro with.',
